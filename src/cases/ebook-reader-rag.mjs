...
import { RunnableSequence, RunnableLambda, Runnable } from '@langchain/core/runnables'
...
// PromptTemplate: 负责把context / question 拼成最终 prompt
...
// 组合成完整的RAG Runnable（检索 -> 构建 prompt 输入 -> PromptTemplate -> LLM -> 文本）
const ragChain = RunnableSequence.from([
  ...
  new RunnableLambda({
    func: async input => {
      ...
      if (!hasContext) {
        const fallback = '抱歉，我没有找到相关的小说内容来回答你的问题。请尝试提问其他问题，或者提供更多细节。'
